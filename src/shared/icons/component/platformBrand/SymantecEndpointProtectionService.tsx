...
const SvgSymantecEndpointProtectionService = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg
		...
		{...props}
	>
		<g clipPath="url(#Symantec-EndpointProtectionService_svg__a)">
			<path
				fill="#fff"
		...
		<defs>
			<clipPath id="Symantec-EndpointProtectionService_svg__a">
				<path fill="#fff" d="M0 0h24v24H0z" />
			</clipPath>
		</defs>
	</svg>
);
const ForwardRef = forwardRef(SvgSymantecEndpointProtectionService);
