...
const SvgOm = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg
	...
	>
		...
		<g id="om_svg__a" fill="#fff" fillRule="evenodd" stroke="#db161b" strokeWidth={0.352}>
			<rect width={38.669} height={21.217} x={65.854} y={102.64} strokeWidth={0.378} rx={3.215} ry={3.015} />
		...
		<use xlinkHref="#om_svg__a" width="100%" height="100%" x={-300} transform="scale(-1 1)" />
		...
		<use xlinkHref="#om_svg__b" width="100%" height="100%" x={-300} transform="scale(-1 1)" />
		<path
			fill="#fff"
			fillRule="evenodd"
			stroke="#db161b"
		...
		/>
		<path fill="#fff" stroke="#db161b" strokeWidth={0.364} d="M145.87 54.017h8.489v7.072h-8.489z" />
		<path fill="#fff" stroke="#db161b" strokeWidth={0.38} d="M145.51 47.829h9.221v6.188h-9.221z" />
		<ellipse
			cx={237.4}
			cy={161.22}
			fill="#fff"
...
const ForwardRef = forwardRef(SvgOm);
