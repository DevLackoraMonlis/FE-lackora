...
const SvgEs = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg
		...
		<g stroke="#000" strokeWidth={0.39}>
			<g strokeWidth={0.26}>
				...
				<g id="es_svg__b" fill="none">
					...
					/>
					<path strokeWidth={0.01} d="M176.8 226.08v-1.16m-.58 1.2.01-1.23m-.43 1.25v-1.26" />
					...
					<path strokeWidth={0.12} d="m171.24 225.82-.01-.62m.26.66v-.7m-.5.61v-.55" />
			...
			<g fill="#c8b100">
				...
				<ellipse cx={250.05} cy={167.3} fill="#005bbf" strokeWidth={0.26} rx={4.43} ry={4.2} />
				<path
					strokeWidth={0.26}
			...
			<g fill="none">
				...
				/>
				<path strokeWidth={0.05} d="M258.04 224.28v-6.01m-3.02 6.21.04-6.37m-2.24 6.45v-6.49" />
			...
			<g strokeWidth={0.52}>
				...
				<g fill="none" strokeWidth={0.39}>
					...
					<path strokeWidth={0.26} d="M282.57 240.9s-.34-.48-.42-.65c-.09-.15-.23-.48-.23-.48" />
...
const ForwardRef = forwardRef(SvgEs);
