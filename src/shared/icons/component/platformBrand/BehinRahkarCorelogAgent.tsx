...
const SvgBehinRahkarCorelogAgent = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg
		...
		{...props}
	>
		<g clipPath="url(#BehinRahkar-CorelogAgent_svg__a)">
			<g
				fill="#FF7518"
				fillRule="evenodd"
				clipPath="url(#BehinRahkar-CorelogAgent_svg__b)"
				clipRule="evenodd"
			>
		...
		<defs>
			<clipPath id="BehinRahkar-CorelogAgent_svg__a">
				<path fill="#fff" d="M0 0h24v24H0z" />
			</clipPath>
			<clipPath id="BehinRahkar-CorelogAgent_svg__b">
				<path fill="#fff" d="M2 2h20v20H2z" />
			</clipPath>
		</defs>
	</svg>
);
const ForwardRef = forwardRef(SvgBehinRahkarCorelogAgent);
