...
const SvgHn = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg
	...
	>
		...
		<path id="hn_svg__a" fill="#0d3b99" d="m630 280 20.572 63.315-53.859-39.131h66.573l-53.859 39.131z" />
		<g id="hn_svg__b">
...
const ForwardRef = forwardRef(SvgHn);
