...
const SvgTw = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600" width="1em" height="1em" ref={ref} {...props}>
		...
		/>
		<circle cx={225} cy={150} r={60} fill="#fff" stroke="#000095" strokeWidth={7.5} />
	</svg>
);
const ForwardRef = forwardRef(SvgTw);
