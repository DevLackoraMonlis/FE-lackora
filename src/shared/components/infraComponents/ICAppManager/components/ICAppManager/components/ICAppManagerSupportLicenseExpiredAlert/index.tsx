			...
			<div className={classes.textRoot}>
				<p className={classes.alertText}>
					...
					<span className={classes.alertDescriptionText}>
						...
						commercial plugins. To restore access to all plugin activations, please renew your support
						license. For help with renewal or any questions, contact our support team.
					</span>
				</p>
				<Button onClick={props.onGotoLicenseManagement} className={classes.goLicense}>
