...
const SvgDellEqualLogic = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg
		...
		{...props}
	>
		<g clipPath="url(#Dell-EqualLogic_svg__a)">
			<g clipPath="url(#Dell-EqualLogic_svg__b)">
				<path
					fill="#007DB8"
		...
		<defs>
			<clipPath id="Dell-EqualLogic_svg__a">
				<path fill="#fff" d="M0 0h24v24H0z" />
			</clipPath>
			<clipPath id="Dell-EqualLogic_svg__b">
				<path fill="#fff" d="M3 3h18v18H3z" />
			</clipPath>
		</defs>
	</svg>
);
const ForwardRef = forwardRef(SvgDellEqualLogic);
