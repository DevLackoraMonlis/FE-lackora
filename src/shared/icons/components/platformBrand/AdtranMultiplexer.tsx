...
const SvgAdtranMultiplexer = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg
		...
		{...props}
	>
		<g clipPath="url(#Adtran-Multiplexer_svg__a)">
			<g clipPath="url(#Adtran-Multiplexer_svg__b)">
				<path
					fill="#006C86"
				...
				<g mask="url(#Adtran-Multiplexer_svg__c)">
					<path
						fill="#006C86"
		...
		<defs>
			<clipPath id="Adtran-Multiplexer_svg__a">
				<path fill="#fff" d="M0 0h24v24H0z" />
			</clipPath>
			<clipPath id="Adtran-Multiplexer_svg__b">
				<path fill="#fff" d="M1 8h22v6H1z" />
			</clipPath>
		</defs>
	</svg>
);
const ForwardRef = forwardRef(SvgAdtranMultiplexer);
