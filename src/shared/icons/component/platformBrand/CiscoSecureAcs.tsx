...
const SvgCiscoSecureAcs = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg
	...
	>
		<g clipPath="url(#Cisco_Secure_ACS_svg__a)">
			<path fill="#007EBA" stroke="#fff" strokeWidth={0.4} d="m2.316 6.92 2.248-1.747h17.115L19.37 6.92z" />
			<path
				stroke="#fff"
				strokeLinecap="round"
			...
			/>
			<path fill="#007EBA" stroke="#fff" strokeWidth={0.4} d="M19.436 6.828v12.02H2.25V6.807z" />
			<path fill="#007EBA" stroke="#fff" strokeWidth={0.4} d="M21.597 17.01V5.216l-2.205 1.655v11.902z" />
			<path
				fill="#fff"
			...
			/>
			<path fill="#fff" stroke="#000" strokeWidth={0.2} d="m7.88 14.868-2.195 2.439.848.753 2.195-2.438z" />
			<path
				fill="#fff"
				stroke="#000"
				strokeWidth={0.2}
