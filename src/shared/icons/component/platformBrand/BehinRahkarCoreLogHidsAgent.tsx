...
const SvgBehinRahkarCoreLogHidsAgent = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg
	...
	>
		<g
			fill="#184D9E"
			fillRule="evenodd"
			clipPath="url(#BehinRahkar-CoreLogHIDSAgent_svg__a)"
			clipRule="evenodd"
		>
		...
		<defs>
			<clipPath id="BehinRahkar-CoreLogHIDSAgent_svg__a">
				<path fill="#fff" d="M0 0h24v24H0z" />
			</clipPath>
		</defs>
	</svg>
);
const ForwardRef = forwardRef(SvgBehinRahkarCoreLogHidsAgent);
