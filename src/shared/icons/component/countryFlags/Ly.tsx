...
const SvgLy = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 480" width="1em" height="1em" ref={ref} {...props}>
...
const ForwardRef = forwardRef(SvgLy);
