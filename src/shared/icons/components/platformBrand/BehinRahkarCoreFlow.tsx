...
const SvgBehinRahkarCoreFlow = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg
		...
		{...props}
	>
		<g fill="#184D9E" fillRule="evenodd" clipPath="url(#BehinRahkar-CoreFlow_svg__a)" clipRule="evenodd">
		...
		<defs>
			<clipPath id="BehinRahkar-CoreFlow_svg__a">
				<path fill="#fff" d="M0 0h24v24H0z" />
			</clipPath>
		</defs>
	</svg>
);
const ForwardRef = forwardRef(SvgBehinRahkarCoreFlow);
