...
import { AppLogoDark } from "@/shared/icons/component/general";
...
export default function ICLoginForm() {
	...
	return (
		<Card h={"100%"} p={"xxl"} radius={"0 16px 16px 0"}>
						...
						>
							<Flex mt={"xl"} gap={"xl"} direction={"column"} w={"100%"}>
								...
								{error === "credentials" && (
									...
									>
										Incorrect username or password. Please try again. You have 2
										attempts left before your account is locked.
									</Alert>
								)}
