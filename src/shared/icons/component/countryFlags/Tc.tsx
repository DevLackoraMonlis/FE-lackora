...
const SvgTc = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg
	...
	>
		<defs>
			...
			<path id="tc_svg__c" d="M840-1000v720C840 200 600 717 0 997-600 717-840 200-840-280v-720z" />
		</defs>
		<g fill="#012169">
			<path d="M0 0h4800A2683.282 2683.282 0 0 1 0 2400z" />
			<g fill="none">
				<path stroke="#fff" strokeWidth={480} d="m0 0 4800 2400M0 2400 4800 0" clipPath="url(#tc_svg__a)" />
				<path
					stroke="#ce1126"
					strokeWidth={4}
					...
					transform="scale(80)"
				/>
				<path stroke="#fff" strokeWidth={800} d="M2400-400v3200M-400 1200h5600" clipPath="url(#tc_svg__a)" />
...
const ForwardRef = forwardRef(SvgTc);
