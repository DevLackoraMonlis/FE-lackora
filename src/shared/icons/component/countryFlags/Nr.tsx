...
const SvgNr = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 300" width="1em" height="1em" ref={ref} {...props}>
...
const ForwardRef = forwardRef(SvgNr);
