...
const SvgTk = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg
	...
	>
		...
		/>
		<g fill="#fff">
			<use xlinkHref="#tk_svg__b" transform="matrix(45 0 0 45 342.957 112.581)" />
			<use xlinkHref="#tk_svg__b" transform="matrix(37.5 0 0 37.5 521.205 267.53)" />
			<use xlinkHref="#tk_svg__b" transform="matrix(45 0 0 45 135 321.808)" />
			<use xlinkHref="#tk_svg__b" transform="matrix(52.5 0 0 52.5 342.957 652.581)" />
		</g>
	</svg>
);
const ForwardRef = forwardRef(SvgTk);
