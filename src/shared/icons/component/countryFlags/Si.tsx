...
const SvgSi = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
	<svg
	...
	>
		...
		<g transform="matrix(.021 0 0 .021 -.106 3.478)">
			...
			<g id="si_svg__b" fill="#ffe500">
				<path id="si_svg__a" fill="#ffe500" fillRule="evenodd" d="M134.094-109.56h6.96l-3.48 6.027" />
				<use xlinkHref="#si_svg__a" width={600} height={300} transform="matrix(1 0 0 -1 0 -215.104)" />
			</g>
			<g fill="#ffe500">
				<use xlinkHref="#si_svg__b" width={600} height={300} transform="translate(20.72)" />
				<use xlinkHref="#si_svg__b" width={600} height={300} transform="translate(10.36 13.875)" />
			</g>
		</g>
		<path
			fill="red"
...
const ForwardRef = forwardRef(SvgSi);
